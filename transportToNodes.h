...
void transportToNodes(route_t arrayOfRoutes[], int totalRoutes, routeFile_t routes[], char arrivalCity[], char departureCity[]) {
    ...
    transport(arrayOfRoutes,totalRoutes,routes,distanceFromStation,"IC",luggage,0,0);
    transport(arrayOfRoutes,totalRoutes,routes,distanceFromStation,"ICL",luggage,0,0);
    transport(arrayOfRoutes,totalRoutes,routes,distanceFromAirport,"Airplane",luggage,90,30);

    comparison(arrayOfRoutes,totalRoutes,routes,"Time");
